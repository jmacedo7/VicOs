...
export default async function BillingPage() {
  ...
  const keys = process.env.SUPABASE_SERVICE_ROLE_KEY
    ? (await createAdminClient().from("api_keys").select("id,name,prefix,scopes,expires_at,last_used_at,revoked_at").eq("company_id",membership.company_id).order("created_at",{ascending:false})).data
    : [];
